...
class articleActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val keyword4: String = intent.getStringExtra("top4")
        val keyword5: String = intent.getStringExtra("top5")

        val url1: String = "https://search.naver.com/search.naver?query="
        val url2: String = "&where=news&ie=utf8&sm=nws_hty"
        myWebView.loadUrl(url1 + keyword1 + "+" + keyword2 + "+" + keyword3 + "+" + keyword4 + "+" + keyword5 + url2)
        Log.d("기사 주소", url1 + keyword1 + "+" + keyword2 + "+" + keyword3  + "+" + keyword4 + "+" + keyword5+ url2)
